...
class VerifyCsrfToken extends Middleware
{
    ...
    protected $except = [
        ...
        '/checkUsername', '/checkEmail', '/password/change', '/updateUser', '/sendEmailAgain', '/forgotPassword', '/emailVerified','/loadMessages', '/saveMessage','/loadUserChats','/loadLoggedInUser'
    ];
}
